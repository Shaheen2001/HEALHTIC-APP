...
class _OnBoardingState extends State<OnBoarding> {
  List<OnBoardingUser>OnBoardinguserItems=[
    OnBoardingUser(
        image: 'assert/image/1ob2.png',
        title: "Flexible Operaling\n Hours",
        text: "Our new service makes it easy for you to \n work anywhere,ther are new features \n will really help you.",

    ),
    OnBoardingUser(
      image: 'assert/image/12ob.png',
      title: "Clinical Management",
      text: "Our new service makes it easy for you to \n work anywhere,ther are new features \n will really help you.",

    ),
    OnBoardingUser(
      image: 'assert/image/13ob.png',
                                 ...
                                 Diohelper.SaveData(key:'OnBoarding', value: true).then((value) {
                                   if(value){
                                     ...
                                     pushAndRemoveUntil(
                                         context,
                                         MaterialPageRoute(
                                             builder:(context)=>HomeCreatScreen(),
                                         ),
                                             (route) => false);
                                   }
                                 });
